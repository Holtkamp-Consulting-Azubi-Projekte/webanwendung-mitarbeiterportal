...
-- Hub für Benutzer
CREATE TABLE H_USER (
    HK_USER VARBINARY(32) PRIMARY KEY, -- Hash Key (z.B. SHA-256 Hash der USER_ID)
...
CREATE TABLE H_PROJECT (
    HK_PROJECT VARBINARY(32) PRIMARY KEY, -- Hash Key (z.B. SHA-256 Hash des PROJECT_NAME)
...
CREATE TABLE L_USER_PROJECT_TIMEENTRY (
    HK_USER_PROJECT_TIMEENTRY VARBINARY(32) PRIMARY KEY, -- Hash Key (z.B. Hash aus HK_USER, HK_PROJECT, TIMEENTRY_ID)
    HK_USER VARBINARY(32) NOT NULL, -- Fremdschlüssel zu H_USER
    HK_PROJECT VARBINARY(32) NOT NULL, -- Fremdschlüssel zu H_PROJECT
...
CREATE TABLE S_TIMEENTRY_DETAILS (
    HK_USER_PROJECT_TIMEENTRY VARBINARY(32) NOT NULL, -- Fremdschlüssel zu L_USER_PROJECT_TIMEENTRY
    T_FROM TIMESTAMP NOT NULL,      -- Technischer Gültigkeitsbeginn (Teil des Primary Key)
    T_TO TIMESTAMP NULL,            -- Technisches Gültigkeitsende
...
CREATE TABLE S_USER_CURRENT_PROJECT (
    ...
    REC_SRC VARCHAR(255) NOT NULL,      -- Quelle des Datensatzes
    HK_PROJECT VARBINARY(32) NOT NULL,  -- Fremdschlüssel zu H_PROJECT (das aktuell zugewiesene Projekt)
